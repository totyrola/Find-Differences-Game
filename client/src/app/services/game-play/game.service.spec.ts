...
describe('GameService', () => {
    ...
    it('should reset the number of differences found', () => {
        service.differencesFound = 10;
        service.reset();
        expect(service.differencesFound).toEqual(0);
    });

    it('should increment the number of differences found', () => {
        const intialNbrDifferences = 10;
        service.differencesFound = intialNbrDifferences;
        service.incrementDifferencesFound({ differenceNaturalOverlay: '', differenceFlashOverlay: '' });
        expect(service.differencesFound).toEqual(intialNbrDifferences + 1);
    });
