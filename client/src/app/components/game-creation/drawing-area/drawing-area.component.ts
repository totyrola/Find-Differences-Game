...
export class DrawingAreaComponent implements OnInit {
    ...
    onMouseMove(e: MouseEvent): void {
        if (this.isDrawing) {
            this.selectedToolService.selectedTool.onMouseMove(this.getMouseCoord(e), this.getCanvasContext());
        }
    }
    ...
    onKeyDown(e: KeyboardEvent): void {
        if (this.isDrawing) {
            if (this.selectedToolService.selectedTool.onKeyDown) this.selectedToolService.selectedTool.onKeyDown(e.key, this.getCanvasContext());
        }
    }
    ...
    onKeyUp(e: KeyboardEvent): void {
        if (this.isDrawing) {
            if (this.selectedToolService.selectedTool.onKeyUp) this.selectedToolService.selectedTool.onKeyUp(e.key, this.getCanvasContext());
        }
    }
