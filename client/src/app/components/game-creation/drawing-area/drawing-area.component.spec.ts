...
describe('DrawingAreaComponent', () => {
    ...
    it(
        ...
        () => {
            ...
            expect(selectedToolServiceSpy.selectedTool.onMouseMove).toHaveBeenCalledWith(fakeCoords, fakeContext);
        },
    );
    ...
    it('should call onKeyDown of the selectedTool with the canvas context when it receives a KeyDown event and drawing is active', () => {
        ...
        expect(selectedToolServiceSpy.selectedTool.onKeyDown).toHaveBeenCalledWith('a', fakeContext);
    });
    ...
    it('should call onKeyUp of the selectedTool with the canvas context when it receives a KeyUp event and drawing is active', () => {
        ...
        expect(selectedToolServiceSpy.selectedTool.onKeyUp).toHaveBeenCalledWith('a', fakeContext);
    });
